        ...
        <div className="flex flex-1 flex-col justify-between bg-white p-6">
          <div className="flex-1">
            ...
            <a href={data.href} className="mt-2 block">
              <p id={index} className="lg:text-4xl pb-6 pt-4 text-2xl font-semibold transition duration-400 ease-in-out text-gray-900">{data.title}</p>
              <p className="mt-3 text-xl leading-8 text-gray-500">{data.description}</p>
            </a>
          </div>
        </div>
      </Link>

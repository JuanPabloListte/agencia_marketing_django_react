...
const navigation = {
    ...
    social: [
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/juampilistte/',
        icon: (props) => (
      ...
      {
        name: 'GitHub',
        href: 'https://github.com/JuanPabloListte',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
    ...
    return(
        ...
        <div className="mx-auto max-w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base text-gray-400 xl:text-center">&copy; 2023 Listte Marketing, Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
